        ...
        <div className="row">
          {posts.slice(0, Data.numOfItems).map((item, key) => (
            <div className="col-xl-4" key={`latest-posts-item-${key}`}>
              ...
              <Link
                href={`/blog/${item.id}`}
                className={`mil-card-1 mil-icon-2-trigger${
                  layout != 2 ? " mil-accent-trigger" : ""
                } mil-appearance mil-mb-30`}
              >
                <div
                  className={`mil-cover${
                    !imageHorizontal ? " mil-square" : ""
                  }`}
                >
                ...
                <div
                  className={`mil-overlay${
                    layout != 2 ? " mil-inside mil-gradient-overlay" : ""
                  }`}
                >
                  <div className="mil-description">
                    <div className="mil-post-info mil-mb-30">
                      {item.category.map((cat, key2) => (
                        <span
                          key={`latest-posts-item-${key}-category-${key2}`}
                    ...
                    <h5 className={`${layout != 2 ? "mil-light" : ""}`}>
                      {item.title}
                    </h5>
                  </div>
                </div>
