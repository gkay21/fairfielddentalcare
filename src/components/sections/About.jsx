    ...
    <div className="container mil-p-120-0">
      <div className="row justify-content-between align-items-center">
        <div className="mil-12 col-xl-5 mil-mb-120">
          ...
          <p className="mil-appearance mil-mb-30">{Data.description1}</p>
          <p className="mil-appearance mil-mb-30">{Data.description2}</p>
          <p className="mil-appearance mil-mb-30">{Data.description3}</p>

          {/* buttons */}
          <div className="mil-appearance">
            <Link
              href={Data.button1.link}
              className="mil-button mil-button-lg mil-button-dark mil-scale-down-trigger mil-accent-trigger mil-buttons-space"
            >
