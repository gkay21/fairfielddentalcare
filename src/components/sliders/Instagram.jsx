    ...
    <div className="mil-instagram-frame mil-appearance">
      ...
      >
        {Data.images.map((item, key) => (
          <SwiperSlide
            className="swiper-slide mil-instagram-item"
      ...
      <div className="mil-button-positions mil-appearance">
        <a
          ...
          target="_blank"
          className="mil-button mil-button-lg mil-button-rounded mil-button-light mil-scale-down-trigger"
        >
          <span>
            <i className="fab fa-instagram"></i> {Data.button.label}
          </span>
        </a>
      </div>
    </div>
